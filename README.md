...
<img src="./assets/banner/phrolova-banner.jpg" alt="Acceleratorer profile banner" width="100%" />
...
I care about building AI projects that are not only impressive in demos, but also structured, reproducible, measurable, and useful in real workflows.
...
I also learn by reading, running, and modifying large systems. These repositories are useful for understanding production-level architecture and engineering trade-offs.
...
This is not just collecting repositories. The goal is to study architecture, reproduce core flows, and learn how real systems are organized.
